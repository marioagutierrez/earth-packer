    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      if (!valueOrDefault<bool>(currentUserDocument?.verified, false)) {
        if (valueOrDefault<bool>(currentUserDocument?.inReviewKyc, false)) {
          ...
          context.pushNamed(WaitingKycResponseWidget.routeName);
        }
      }
    });
          ...
          children: [
                        ...
                        children: [
                                    ...
                                    child: Container(
                                      ...
                                      child: TextFormField(
                                        ...
                                        decoration: InputDecoration(
                                          ...
                                          hintText: 'Búsca tu próxima posición',
                            ...
                            child: Padding(
                              ...
                              child: StreamBuilder<List<FeaturedRecord>>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  List<FeaturedRecord>
                                      containerFeaturedRecordList =
                                      snapshot.data!;
                                  // Return an empty Container when the item does not exist.
                                  if (snapshot.data!.isEmpty) {
                                    return Container();
                                  }
                                  final containerFeaturedRecord =
                                      containerFeaturedRecordList.isNotEmpty
                                          ? containerFeaturedRecordList.first
                                          : null;
                                  ...
                                  return Container(
                                    ...
                                    decoration: BoxDecoration(),
                                    child: Visibility(
                                      visible: containerFeaturedRecord != null,
                                      child: Column(
                                        mainAxisSize: MainAxisSize.max,
                                        crossAxisAlignment:
                                        ...
                                        children: [
                                          ...
                                          wrapWithModel(
                                            model: _model.experienciaCardModel1,
                                            updateCallback: () =>
                                                safeSetState(() {}),
                                            child: ExperienciaCardWidget(
                                              exp: containerFeaturedRecord!
                                                  .experiencia!,
                                            ),
                                          ),
                                        ],
                          ...
                          Expanded(
                            child: Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  0.0, 5.0, 0.0, 8.0),
                              child: StreamBuilder<List<ExperienciaRecord>>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  return ListView.separated(
                                    ...
                                    itemCount:
                                        listViewExperienciaRecordList.length,
                                    ...
                                    itemBuilder: (context, listViewIndex) {
                                      ...
                                      return wrapWithModel(
                                        model: _model.experienciaCardModels2
                                            .getModel(
                                          listViewExperienciaRecord
                                              .reference.id,
                                          listViewIndex,
                                        ),
                                        updateCallback: () =>
                                        ...
                                        child: ExperienciaCardWidget(
                                          key: Key(
                                            'Key53e_${listViewExperienciaRecord.reference.id}',
                                          ),
            ...
            if (false)
              Align(
                alignment: AlignmentDirectional(0.0, 0.0),
                child: wrapWithModel(
                  model: _model.accountAproveAlertModel,
                  updateCallback: () => safeSetState(() {}),
                  child: AccountAproveAlertWidget(),
                ),
              ),
          ],
        ),
