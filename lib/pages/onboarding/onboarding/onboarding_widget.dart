                                        ...
                                        Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  0.0, 16.0, 0.0, 0.0),
                                          child: Text(
                                            'Colabora con afitriones alrededor del mundo intercambiando tus habilidades por hospedaje.',
                                            textAlign: TextAlign.center,
                                            style: FlutterFlowTheme.of(context)
                                                .labelLarge
                                                .override(
                                        ...
                                        Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  0.0, 16.0, 0.0, 0.0),
                                          child: Text(
                                            'Hemos buscado en nuestra comunidad de miles de anfitriones para encontrar las mejores experiencias para ti.',
                                            textAlign: TextAlign.center,
                                            style: FlutterFlowTheme.of(context)
                                                .labelLarge
                                                .override(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            await _model.staggeredViewController?.animateTo(
                              _model.staggeredViewController!.position
                                  .maxScrollExtent,
