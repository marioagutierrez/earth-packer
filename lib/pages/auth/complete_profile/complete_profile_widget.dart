...
class _CompleteProfileWidgetState extends State<CompleteProfileWidget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<PaisesRecord>>(
      stream: queryPaisesRecord(),
      builder: (context, snapshot) {
        ...
        List<PaisesRecord> completeProfilePaisesRecordList = snapshot.data!;
                  ...
                  children: [
                              ...
                              child: Row(
                                ...
                                children: [
                                  FlutterFlowDropDown<String>(
                                    ...
                                    options: completeProfilePaisesRecordList
                                        .map((e) => e.phoneCode)
                                        .toList(),
                    ...
                    Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          _model.link = await KycCall.call(
                          ...
                          await currentUserReference!
                            ...
                            kycCheck: KycCall.url(
                              (_model.link?.jsonBody ?? ''),
                            ),
                            verified: false,
                            estudiante: _model.checkboxValue4,
                            intituto: _model.checkboxValue3,
                          ));
                          await launchURL(KycCall.url(
                            (_model.link?.jsonBody ?? ''),
                          )!);
                          if (_model.checkboxValue1 == true) {
                            ...
                            context
                                .pushNamed(RegistroIntitucionWidget.routeName);
                          } else if (_model.checkboxValue4!) {
                            context
                                .pushNamed(CompleteStudianteWidget.routeName);
                          } else {
                            context
                                .pushNamed(CompleteAnfitrionWidget.routeName);
                          }
