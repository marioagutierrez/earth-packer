            ...
            children: [
                ...
                children: [
                  Flexible(
                    child: Padding(
                      ...
                      child: Text(
                        'No haz completado la verificacion KYC haz click en el siguiente boton para completar la verificación de identidad, ten a la mano tu documento de identidad.',
              ...
              Padding(
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    await launchURL(
                        valueOrDefault(currentUserDocument?.kycCheck, ''));
                  },
                  text: 'Completar KYC',
